-- I use this as reference in case I need to know how to write different kinds of tests :)
...
-- test_addition =
--   testProperty "Addition commutes" $ \(a :: Int) (b :: Int) -> a + b == b + a
...
-- test_generateTrees =
--   map (\s -> testCase s $ pure ()) <$> pure ["First input", "Second input"]
